            ...
            <div key={res.chunk.id} className="group relative animate-in fade-in slide-in-from-right duration-700" style={{ animationDelay: `${i * 100}ms` }}>
              ...
              <div className="flex items-center justify-between mb-6">
                <div className="flex items-center space-x-5">
                  ...
                  {res.chunk.metadata.pageNumber && (
                    <span className="text-[11px] font-black text-emerald-400 bg-emerald-600/10 px-4 py-2 rounded-xl border border-emerald-500/30 shadow-xl uppercase tracking-[0.15em]">
